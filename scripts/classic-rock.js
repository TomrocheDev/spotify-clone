    ...
    <div id="main-header-section">
        ...
        <div id="header-playlist-details">
            <div id="playlist-image-container">
                <img
                    src="https://i.scdn.co/image/ab67706f000000020c0ac878866d5d08bddb2b0a"
                    alt="Playlist cover" />
            </div>
            <div id="header-playlist-titles">
                ...
                <h1 id="playlist-title">Classic Rock</h1>
                <div id="playlist-duration">
                    <span>FictionalUsername</span>
                    <i class="fa-solid fa-circle" style="font-size: 6px"></i>
                    <span>36 nummers, </span>
                    <span style="color: var(--inactive)">ongeveer 3 uur</span>
                </div>
            </div>
        </div>
